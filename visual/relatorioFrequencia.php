...
<div class="row">
  <div class="col-sm-3 menu">
    ...
    <div class="col-sm-9 divdireita">
        ...
        <br/>
        <div class="p-1 mb-1 bg-primary text-white"><h4 class="text-center">Relatório de Frequência</h4></div>
            ...
            <table class="table table-dark">
                <form>
                    ...
                    <?php
                        ...
                        $sqlmesreferencia = "SELECT mesreferencia, nome, datatreino, presenca FROM frequenciadiaria_tbl WHERE mesreferencia='$mesreferencia'";
