...
<body>
    ...
    <div class="col-sm-9 divform bg-dark text-white">
        <h4 class="text-center">Dados Formas de Pagamento</h4>
        <br/>
        <div class="table-responsive">
            ...
            <form>
                ...
                <?php
                    ...
                    $sql = "SELECT formaspgto, observacao FROM formaspgto_tbl WHERE id=$formaspgto";
        ...
        <div class="col text-center">
            <a href="minhasFormasPgto.php" class="btn btn-secondary">sair</a>
        </div>
