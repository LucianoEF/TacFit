...
<div class="row">
  <div class="col-sm-3 menu">
    ...
    <!-- Tentativa 01 -->
        ...
        <br/>
        <div class="p-1 mb-1 bg-primary text-white"><h4 class="text-center">Relatório de Recebimentos</h4></div>
            <div class="table-responsive">
                ...
                <form>
                    ...
                    <?php
                        ...
                        $sqlmesreferencia = "SELECT nome, datapgto, mesreferencia, formaspgto, valor FROM recebimentos_tbl WHERE mesreferencia='$mesreferencia'";
